          ...
          <div>
            <div className="container">
              <div className="mb-[50px] md:mb-[70px] xl:mb-[100px] flex justify-between flex-wrap">
                ...
                <Link href="/contact" className="btn btn-primary btn-icon hover-translate max-w-max mt-[20px] md:mt-[35px] xl:mt-[40px]">
                  CONTACT
                  <span className="icon">
              ...
              <div className="flex flex-wrap gap-y-8 w-full text-center justify-between font-jet text-xs items-center">
                ...
                <span className="font-xs block m-auto md:m-0">© 2025 MITHUN RAJ</span>
              </div>
            </div>
          </div>
        </div>
