          ...
          <div className="w-[80%] ml-auto">
            ...
            <section className="box ">
              <div id="buttons" className="pb-20">
                <h3 class="ttl text-[26px] mb-6">Buttons</h3>
                <div className="item-wrp">
            ...
            <div id="border-radious" className="pb-20">
              <h3 class="ttl text-[26px] mb-6">Border radius</h3>
              <div className="flex">
            ...
            <div id="typeography" className={`pb-20 ${Style.typography}`}>
              <h3 class="ttl text-[26px] mb-6">Typography</h3>
            ...
            <div id="box-shadow" className="pb-20">
              <h3 class="ttl text-[26px] mb-6">Shadow</h3>
              <div className="flex">
